...
export function createSampleBerlinItinerary(): TripItinerary {
  ...
  return {
    ...
    description: "Complete vegan travel itinerary featuring the best plant-based restaurants, guided food tours, and community events in Berlin. Generated by VeganBnB AI with actionable logistics and transit planning.",
